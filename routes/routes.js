...
router.put('/posts/:postId/:commentIdx/editComment', isAuth, postController.editComment);

router.delete('/posts/:postId/:commentIdx/deleteComment', isAuth, postController.deleteComment);
